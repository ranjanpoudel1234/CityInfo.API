...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController : Controller
    {
        ...
        public PointsOfInterestController(ILogger<PointsOfInterestController> logger, IMailService mailService, ICityInfoRepository cityInfoRepository)
        {
            ...
            // HttpContext.RequestServices.GetService();// another possible way of calling service
        }

        [HttpGet("{cityId}/pointsofinterest")]
        public IActionResult GetPointsoOfInterest(int cityId)
        {
            try
            {
        ...
        // this helps for partial update of the dto.
            ...
            [FromBody] JsonPatchDocument<PointsOfInterestForUpdateDto> patchDoc)
        {
            ...
            var pointOfInterestToPatch =
                  Mapper.Map<PointsOfInterestForUpdateDto>(pointOfInterestEntity);
